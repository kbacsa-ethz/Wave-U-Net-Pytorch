...
train_data = SeparationDatasetLMDB(musdb, "train", ["bass", "drums", "other", "vocals"], 44100, 2, model_shapes, True,
                               'lmdb', audio_transform=augment_func)
test_data = SeparationDatasetLMDB(musdb, "test", ["bass", "drums", "other", "vocals"], 44100, 2, model_shapes, True,
                                   'lmdb', audio_transform=augment_func)
val_data = SeparationDatasetLMDB(musdb, "val", ["bass", "drums", "other", "vocals"], 44100, 2, model_shapes, True,
                                  'lmdb', audio_transform=augment_func)
